...
Location: San Francisco, CA`
        ...
        github: {
            ...
            usage: 'github',
            fn: () => {
                window.open('https://github.com/gitcohub', '_blank')
        ...
        social: {
            ...
            usage: 'social',
            fn: () => `Twitter: @Dey_Dey2020
LinkedIn: /in/rajdeepdey
Portfolio: rajdeepdey.dev`
        },
        echo: {
